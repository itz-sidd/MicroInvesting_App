...
const Index = () => {
  ...
  const features = [
    {
      icon: PiggyBank,
      title: 'Smart Round-Up Investing',
      description: 'Every purchase automatically rounds up to the nearest dollar, investing your spare change in diversified portfolios.'
    },
    {
      icon: TrendingUp,
      title: 'Professional Management',
      description: 'Our algorithms handle portfolio rebalancing and optimization, so you can focus on what matters most to you.'
    },
    {
      icon: Shield,
      title: 'Security First',
      description: 'Bank-level encryption and SIPC protection ensure your investments are safe and secure at all times.'
    },
    {
      icon: Smartphone,
      title: 'Effortless Experience',
      description: 'Track your progress, adjust settings, and watch your wealth grow through our intuitive mobile app.'
    }
  ];

  const benefits = [
    'Start investing with just your spare change',
    ...
    'Professional-grade security and protection'
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-3xl mx-auto leading-relaxed">
              Turn everyday purchases into investments. Our platform automatically rounds up 
              your transactions and invests the difference in professionally managed portfolios.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 text-sm">
              <Badge variant="secondary" className="px-4 py-2">SIPC Protected</Badge>
              <Badge variant="secondary" className="px-4 py-2">SEC Registered</Badge>
              <Badge variant="secondary" className="px-4 py-2">Bank-Level Security</Badge>
            </div>
            
            <div className="mt-12 text-muted-foreground text-sm">
              <p>Trusted by over 50,000 investors</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Securely link your checking account with bank-level encryption
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Use your linked debit card for everyday transactions
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold">Automatic Investment</h4>
                  <p className="text-sm text-muted-foreground">
                    We round up purchases and invest the spare change automatically
                  </p>
                </div>
              </div>
            </CardContent>
